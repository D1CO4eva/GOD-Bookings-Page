...
const Header: React.FC<HeaderProps> = ({ onNavigate, currentPage, onOpenDonate }) => {
  ...
  const goToBookingsHome = () => {
    const basePath = import.meta.env.BASE_URL || '/homebookings/';
      ...
      <div className="container mx-auto px-4 py-3 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <nav className="flex items-center space-x-1 sm:space-x-4 text-sm md:text-base">
          ...
          <button 
            ...
            className="ml-2 px-4 py-2 bg-[#2E3192] text-white rounded-full font-bold shadow-md hover:bg-[#24287a] transition-all flex items-center space-x-2"
          >
